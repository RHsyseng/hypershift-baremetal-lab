...
(maybe same caution format also in the Introduction page)
...
An OpenShift cluster (this is the management cluster) is running on the infrastructure host, you can reach it out (from where?) at https://console-openshift-console.apps.management.hypershift.lab and https://api.management.hypershift.lab:6443
