...
(is hardware-inventory a required name or just a random name?)
+
[.console-input]
...
[.console-input]
[source,bash,subs="attributes+,+macros"]
(this is long command not possible to view break lines?)
-----
...
(it is always unclear what happens here and what networking is needed. A small ref to such
 graph https://gitlab.consulting.redhat.com/djuran/ericsson-cloud-ran-blueprint/-/raw/main/images/Management%20Cluster%20connectivity.png or further links)
+
