...
Welcome to this Hosted Control Planes for Telcos on Baremetal Lab.

The first part of this lab is an introduction to the required concepts that one needs to know when planning and running Hosted Control Planes on Telco environments. The second part is a practical scenario where we will run a Hosted Control Plane targeting Telco CORE workloads.
