...
There is currently an [existing issue](https://issues.redhat.com/browse/ACM-20200) which prevents HCP cluster upgrades from the UI. The UI section has been disabled and will be brought back when the issue is fixed.
