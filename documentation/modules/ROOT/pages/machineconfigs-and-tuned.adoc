...
-----
+
4. You can also check the NodePool's UPDATINGCONFIG field that reports if the config is currently being updated.
+
[.console-input]
[source,bash,subs="attributes+,+macros"]
-----
...
-----
+
6. The nodes will have the test file.
+
[.console-input]
[source,bash,subs="attributes+,+macros"]
-----
...
-----
+
4. You can also check the NodePool's UPDATINGCONFIG field.
+
[.console-input]
[source,bash,subs="attributes+,+macros"]
-----
