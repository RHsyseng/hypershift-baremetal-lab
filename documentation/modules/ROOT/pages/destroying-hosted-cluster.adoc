...
1. Access the https://console-openshift-console.apps.management.hypershift.lab/[OpenShift Console] and log in with the OpenShift admin credentials you got in the lab's email.
...
3. Select the cluster named `hosted`, and click the `Actions` button. Finally, click `Destroy clusters`.
+
...
+
5. It may take up to five minutes for the hosted cluster to be destroyed.
...
-----
+
IMPORTANT: This command can take up to five minutes to complete. 
+
[console-input]
[source,console]
-----
